...
def card_rects(window_size):
    ...
    return [
        pygame.Rect(margin, margin, card_width, height - margin * 2),
        pygame.Rect(margin + card_width + gap, margin, card_width, height - margin * 2),
    ]
...
def save_scores(states):
    ...
    path = os.path.join(SCORES_DIR, f"duo_servers_{timestamp}.txt")
